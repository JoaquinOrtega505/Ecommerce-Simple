...
namespace EcommerceApi.Migrations
{
    ...
    [Migration("20251125230936_InitialCreate")]
            ...
            modelBuilder.Entity("EcommerceApi.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2025, 11, 25, 23, 9, 35, 520, DateTimeKind.Utc).AddTicks(9779),
                            Nombre = "Administrador",
                            PasswordHash = "$2a$11$Pnq3hW/dKpacRO1AERDLLuXvCOUD3MXWBTLVkLGzcGlMXHV9uZCea",
                            Rol = "Admin"
                        });
                });
